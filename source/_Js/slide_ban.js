...
(function($){
	...
	$.fn.hscrollContent=function(o){
		...
		return this.each(function(){
			...
			o.wrap.css({width:o.li_w * o.vcount, height: o.li_h});			
			$ul.css({width:reTotalWidth , height: o.li_h});
	...
	$.fn.vscrollContent2=function(o){
		...
		return this.each(function(){
			...
			o.wrap.css({width:o.li_w * 2, height: o.li_h  * Math.ceil(o.vcount/2)});			
			$ul.css({width: o.li_w * 2 , height: reTotalSize});
			...
			function goPage(n){
				...
				if(pg!=n){
					...
					var mvTop = -1 * o.li_h * (o.vcount/2) * (n-1);
					$ul.stop().animate({ "top":mvTop},300);
